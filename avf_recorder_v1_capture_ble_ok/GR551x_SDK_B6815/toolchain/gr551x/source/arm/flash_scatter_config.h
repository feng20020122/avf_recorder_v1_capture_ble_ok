...
#else
#define ATT_DB_HEAP_SIZE    MEM_CALC_HEAP_LEN_IN_BYTES(3072)
#endif
...
#define PRF_BUF_SIZE 	(92*USER_MAX_PRFS)
#define BOND_BUF_SIZE 	(8*USER_MAX_BOND_DEVS)
