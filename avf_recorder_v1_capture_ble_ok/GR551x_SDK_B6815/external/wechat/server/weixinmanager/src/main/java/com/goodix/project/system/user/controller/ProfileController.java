...
import com.goodix.common.utils.file.FileUploadUtils;
...
import com.goodix.framework.web.service.DictService;
...
public class ProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(User user, @RequestParam("avatarfile") MultipartFile file)
    {
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(GoodixConfig.getAvatarPath(), file);
