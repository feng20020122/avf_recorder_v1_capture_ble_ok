...
{
    /** 项目空间路径 */
    private static final String PROJECT_PATH = "main/java/com/goodix/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.goodix.project.system"));
    }
}
