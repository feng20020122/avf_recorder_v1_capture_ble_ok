...
public class WxMpXmlMessage implements Serializable {
  ...
  public static WxMpXmlMessage fromJson(String jsonBody) {
    Gson gson = new GsonBuilder().setFieldNamingPolicy(FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES).create();
    return gson.fromJson(jsonBody,WxMpXmlMessage.class);
  }
  ...
  public static WxMpXmlMessage fromEncryptedJson(String encryptedXml, WxMpConfigStorage wxMpConfigStorage,
                                                String timestamp, String nonce, String msgSignature) {
    WxMpCryptUtil cryptUtil = new WxMpCryptUtil(wxMpConfigStorage);
    String plainText = cryptUtil.decrypt(msgSignature, timestamp, nonce, encryptedXml);
